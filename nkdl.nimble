...
task test, "Run unit tests":
  ...
  exec cmd & " tests/test_error_codes.nim"
  exec cmd & " tests/test_value.nim"
  exec cmd & " tests/test_node.nim"
  exec cmd & " tests/test_node_api.nim"
  exec cmd & " tests/test_node_traverse.nim"
  exec cmd & " tests/test_node_clone.nim"
  exec cmd & " tests/test_node_build.nim"
  exec cmd & " tests/test_node_build_parity.nim"
  exec cmd & " tests/test_node_build_negatives.nim"
  ...
  exec cmd & " tests/test_derive_hygiene.nim"
  ...
  exec cmd & " tests/test_coerce.nim"
