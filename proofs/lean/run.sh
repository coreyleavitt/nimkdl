...
"$RUNTIME" run --rm -v "$DIR:/work:Z" -w /work localhost/lean-nkdl \
  sh -c 'for f in Kdl/Value.lean Kdl/Number.lean Kdl/Str.lean Kdl/Doc.lean Kdl/NamedDoc.lean Kdl/ArgsDoc.lean Kdl/RawStr.lean Kdl/Dedent.lean; do echo "== $f =="; lean "$f"; done'
